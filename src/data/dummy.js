...
// 아바타는 Avatar 컴포넌트가 이름에서 생성(이모지 미사용).

export const currentUser = {
  id: 'me',
  username: '나',
  statusMessage: '카카오 스타일 채팅앱 만드는 중',
}

export const friends = [
  { id: 'u1', username: '김하늘', statusMessage: '오늘도 화이팅' },
  { id: 'u2', username: '이준호', statusMessage: '' },
  { id: 'u3', username: '박서연', statusMessage: '여행 가고 싶다' },
  { id: 'u4', username: '최민수', statusMessage: '운동 중' },
  { id: 'u5', username: '정유진', statusMessage: '커피 한 잔의 여유' },
]
